...
export declare class DislikeController {
    ...
    deleteDislike(dislikeId: string): Promise<import("mongoose").Document<unknown, {}, import("./interfaces/dislike.interface").Dislike> & Omit<import("./interfaces/dislike.interface").Dislike & {
        _id: import("mongoose").Types.ObjectId;
    }, never>>;
}
